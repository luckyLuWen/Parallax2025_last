...
#pragma  comment( lib, "../../bin/LCRP.lib")
...
//    pBA->pba_run( false, bLM, 100, szCam, szFea, NULL, szCalib, szReport, NULL, NULL, 1E-3 );
	...
	//========================================================================================
	//Village dataset
 	  char*  szCam = "C:/txtdata/Village4/Cam90.txt";
 	  char*  szFea = "C:/txtdata/Village4/Feature90.txt";
 	  char*  szCalib = "C:/txtdata/Village4/cal90.txt";
	  char* szXYZ = "C:/txtdata/Village4/xyz_Maxdw.txt";
	  //char* szXYZ = NULL;
 	  char*  szReport = "C:/txtdata/Village4/report.txt";	
 	  bool bLM     = false;   //true is Levenberg-Marquardt
	  lcrp->lcrp_run( false, bLM, 100, szCam, szFea, szXYZ, szCalib, szReport, NULL, NULL );
	//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
		//NewCollege
	  ...
	  //bool bLM = true;   //true is Levenberg-Marquardt
	  //sBA->sba_run(false, bLM, 100, szCam, szFea, szXYZ, szCalib, szReport, NULL, NULL);
	//========================================================================================
	//College dataset
