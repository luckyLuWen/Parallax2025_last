...
private:
	...
	void pba_readProjectionAndTriangulateFeature(FILE* fp, double* projs, int ncams);
	void pba_saveTriangulatedxyz(char* sz3Dpt, double* p);
	void pba_saveInitialXYZ(char* sz3Dpt, double* p);
	void pba_saveInitialParallax(char* sz3Dpt, double* p);
	void pba_constructP(double* P, double* K, double* p);
